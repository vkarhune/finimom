...
The priors of this form with $a = 1$ and $b = p^u$ with $u > 1$, are discussed in Castillo (201x).
...
Using LD matrix from an external dataset tend to increase the false positive rate.
